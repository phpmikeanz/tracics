-- SAFE RLS POLICY FIX FOR QUIZ SYSTEM
-- This script safely fixes RLS policies by dropping existing ones first

-- ===========================================
-- STEP 1: DROP ALL EXISTING POLICIES SAFELY
-- ===========================================

-- Drop ALL existing policies on quiz-related tables
