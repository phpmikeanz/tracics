-- TARGETED FIX FOR QUIZ SUBMISSION RLS ERROR
-- This creates the most permissive RLS policies possible while maintaining security
...
-- 2. Create the most permissive RLS policies possible
...
BEGIN
  ...
  IF test_user_id IS NOT NULL THEN
    ...
    INSERT INTO notifications (
      ...
      test_user_id,
      'Test Quiz Notification - Targeted Fix',
